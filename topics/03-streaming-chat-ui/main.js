...
// FEW SHOT PROMPTING: We provide multiple examples of user requests and assistant responses to guide the model in generating structured, relevant gift suggestions based on the user's input. Each example includes a user request describing the gift recipient and constraints, followed by an assistant response that follows the specified format and content guidelines.
const messages = [
  {
    role: "system",
